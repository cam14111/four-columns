...
import { createDeck, dealInitialCards, makeAIMove } from "@/lib/gameLogic";
...
export const GameBoard = () => {
  ...
  const [gameState, setGameState] = useState<GameState>(() => {
    ...
    return {
      players: [
        { id: "1", name: "Player", score: 0, grid: humanGrid, isAI: false },
        { id: "2", name: "AI", score: 0, grid: aiGrid, isAI: true }
      ],
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-8">
            {gameState.players.map((player, index) => (
              <PlayerGrid
                ...
                disabled={index !== gameState.currentPlayerIndex || gameState.gamePhase !== "action"}
              />
            ))}
          </div>
          ...
          <div className="space-y-8">
            <GameControls
              ...
              disabled={gameState.players[gameState.currentPlayerIndex].isAI}
            />
